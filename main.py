...
for task_id, train_taskset in enumerate(scenario_train):
    ...
    val_loader = DataLoader(train_taskset, batch_size=args.batch_size, shuffle=True)
    ...
    for epoch in range(args.epochs):
        train(args, train_loader, memory_loader, model, task_id, criterion_cls, previous_net, optimizer, epoch, lamda, scheduler_lr)
